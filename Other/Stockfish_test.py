...
fen1 = "r2qkb1r/ppp1pppp/n4n2/1N1p1b2/3P1B2/4P3/PPP2PPP/R2QKBNR b kq"
...
time_limit = 8
best_move, score, depth, seldepth, nodes, nps, time_spent = get_stockfish(fen1, time_limit,"./stockfish.exe")
